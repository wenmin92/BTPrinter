...
package com.chinawutong.library.core;
...
public class PrintExecutor {
     ...
     * @return 错误代码
     */
    private int doRequest(com.chinawutong.library.core.PrintDataMaker maker) {
     ...
     * @return 错误代码
     */
    public int doPrinterRequest(com.chinawutong.library.core.PrintDataMaker maker) {
     ...
     * 异步执行打印请求
     */
    public void doPrinterRequestAsync(com.chinawutong.library.core.PrintDataMaker maker) {
    ...
    private class PrintTask extends AsyncTask<com.chinawutong.library.core.PrintDataMaker, Integer, Integer> implements
        ...
        @Override
        protected Integer doInBackground(com.chinawutong.library.core.PrintDataMaker... makers) {
